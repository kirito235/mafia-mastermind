...
export function MafiaCity() {
  ...
  const confirmNameEntry = () => {
    ...
    if (dupe) {
      setNeErr("Someone else tonight already used that exact name — add a last initial to tell you apart.");
      return;
    }
            ...
            <div className="mc-screen" style={{ justifyContent: "center", textAlign: "center" }}>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <button
                  ...
                  style={{
                    flex: 1,
                    visibility: editingFromReview || neIdx > 0 ? "visible" : "hidden",
                  }}
                  onClick={neBack}
                >
          ...
          {screen === "nameReview" && (
            <div className="mc-screen" style={{ gap: 16 }}>
              ...
              <div className="mc-file-card" style={{ textAlign: "left" }}>
                ...
                <select
                  className="mc-gf-select"
                  value={state.godfatherChoice || ""}
                  onChange={(e) => setState((s) => ({ ...s, godfatherChoice: e.target.value || null }))}
                >
          ...
          {screen === "reveal" && currentAssign && (
            <div className="mc-screen" style={{ justifyContent: "flex-start", gap: 16 }}>
              <div className="mc-file-card">
                ...
                <div className="mc-file-text">{ROLE_INFO[currentAssign.role]}</div>
